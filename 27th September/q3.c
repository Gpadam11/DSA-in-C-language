// WAP to convert an infix expression into equivalent postfix expression
...
int infixToPostfix(char *exp)
{
    ...
    for (i = 0, k = -1; exp[i]; ++i) 
    {
        ...
        // If the scanned character is an ‘)’, pop and output from the stackuntil an ‘(‘ is encountered.
        else if (exp[i] == ')')
        {
